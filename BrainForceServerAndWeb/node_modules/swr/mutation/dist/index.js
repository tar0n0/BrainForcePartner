...
var mutation = (function () {
    return function (key, fetcher, config) {
        ...
        var trigger = react.useCallback(function (arg, opts) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, serializedKey, resolvedKey, options, mutationStartedAt, data, error_1;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        options = Object.assign({ populateCache: false }, config, opts);
                    ...
                    case 3:
                        ...
                        // If it's reset after the mutation, we don't broadcast any state change.
                        if (ditchMutationsUntilRef.current <= mutationStartedAt) {
                            setState({ error: error_1, isMutating: false });
                            (_c = options.onError) === null || _c === void 0 ? void 0 : _c.call(options, error_1, serializedKey, options);
                            throw error_1;
                        }
                        return [3 /*break*/, 4];
        ...
        var reset = react.useCallback(function () {
            ...
            setState({ data: _internal.UNDEFINED, error: _internal.UNDEFINED, isMutating: false });
            // eslint-disable-next-line react-hooks/exhaustive-deps
        }, []);
