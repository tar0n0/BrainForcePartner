    ...
    return function (getKey, fn, config) {
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        shouldFetchPage = revalidateAll ||
                            forceRevalidateAll ||
                            _internal.isUndefined(pageData) ||
                            (revalidateFirstPage && !i && !_internal.isUndefined(dataRef.current)) ||
                            shouldRevalidateOnMount ||
                            (originalData &&
                                !_internal.isUndefined(originalData[i]) &&
        ...
        var resolvePagesFromCache = function (pageSize) {
            ...
            for (var i = 0; i < pageSize; ++i) {
                ...
                var pageData = pageKey ? (_a = cache.get(pageKey)) === null || _a === void 0 ? void 0 : _a.data : _internal.UNDEFINED;
