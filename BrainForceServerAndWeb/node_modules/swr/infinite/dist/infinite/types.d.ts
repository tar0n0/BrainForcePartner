import { SWRConfiguration, SWRResponse, Arguments, BareFetcher, State } from 'swr/_internal';
declare type FetcherResponse<Data = unknown> = Data | Promise<Data>;
export declare type SWRInfiniteFetcher<Data = any, KeyLoader extends SWRInfiniteKeyLoader = SWRInfiniteKeyLoader> = KeyLoader extends (...args: any[]) => any ? ReturnType<KeyLoader> extends infer T | null | false | undefined ? (args: T) => FetcherResponse<Data> : never : never;
export declare type SWRInfiniteKeyLoader = (index: number, previousPageData: any | null) => Arguments;
export interface SWRInfiniteConfiguration<Data = any, Error = any, Fn extends SWRInfiniteFetcher<Data> = BareFetcher<Data>> extends SWRConfiguration<Data[], Error> {
    initialSize?: number;
