...
var useSWRHandler = function (_key, fetcher, config) {
    ...
    var selector = function (snapshot) {
        var shouldStartRequest = (function () {
            ...
            if (!_internal.isUndefined(revalidateOnMount))
    ...
    var returnedData = keepPreviousData
        ? _internal.isUndefined(cachedData)
    ...
    var shouldDoInitialRevalidation = (function () {
        // If `revalidateOnMount` is set, we take the value directly.
        if (isInitialMount && !_internal.isUndefined(revalidateOnMount))
            return revalidateOnMount;
        // If it's paused, we skip revalidation.
        if (getConfig().isPaused())
            return false;
        ...
        if (suspense)
            return _internal.isUndefined(data) ? false : config.revalidateIfStale;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!_internal.isUndefined(mutationInfo) &&
                        // case 1
                    ...
                    if (!currentConfig.isPaused()) {
                        ...
                        if (shouldStartNewRequest && callbackSafeguard()) {
                            ...
                            if (shouldRetryOnError === true ||
                                (_internal.isFunction(shouldRetryOnError) &&
    ...
    _internal.useIsomorphicLayoutEffect(function () {
        ...
        function next() {
            ...
            var interval = _internal.isFunction(refreshInterval)
...
var unstable_serialize = function (key) { return _internal.serialize(key)[0]; };
